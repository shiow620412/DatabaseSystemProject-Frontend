    ...
    <div class="content" v-if="productArray.length > 0">
        ...
        <div class="cart-bar">
            ...
            <div class="cart-bar-right">
                ...
                <el-button :class="getCheckQuantity > 0 ? 'btn-primary' : 'btn-primary-disabled'" :disabled="this.productOfChecked.length === 0 ? true : false" @click="this.$router.push({path: '/payment', query: { dataTable: this.productOfChecked }})">結帳</el-button>
            </div>
        </div>
    </div>
